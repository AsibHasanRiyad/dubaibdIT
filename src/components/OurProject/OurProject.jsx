    ...
    <div className=" max-w-[1440px] mx-auto relative px-4 md:px-14 xl:px-[70px] py-[46px] lg:py-[120px]">
      ...
      <div className=" absolute w-[800px] lg:w-[1440px] -top-5 lg:-top-14 left-0 hidden md:block">
        ...
        >
          ...
          />
          <g opacity="0.4">
            <circle cx="1207" cy="131" r="14.5" stroke="#EF4B23" />
            <circle cx="1207" cy="131" r="9.5" stroke="#EF4B23" />
            <circle cx="1207" cy="131" r="19.5" stroke="#EF4B23" />
          </g>
          <g opacity="0.4">
            <circle cx="700" cy="310" r="14.5" stroke="#EF4B23" />
            <circle cx="700" cy="310" r="9.5" stroke="#EF4B23" />
            <circle cx="700" cy="310" r="19.5" stroke="#EF4B23" />
          </g>
        </svg>
      </div>
      ...
      <div className="absolute left-0 block -top-2 md:hidden">
        ...
        >
          ...
          />
          <g opacity="0.4">
            <circle cx="345.453" cy="95.8824" r="4.66184" stroke="#EF4B23" />
            <circle cx="345.453" cy="95.8825" r="2.94123" stroke="#EF4B23" />
            <circle cx="345.453" cy="95.8824" r="6.38245" stroke="#EF4B23" />
          </g>
          <g opacity="0.4">
            <circle cx="176.453" cy="40.8824" r="4.66184" stroke="#EF4B23" />
            <circle cx="176.453" cy="40.8825" r="2.94123" stroke="#EF4B23" />
            <circle cx="176.453" cy="40.8825" r="6.38245" stroke="#EF4B23" />
          </g>
        </svg>
      </div>
    </div>
