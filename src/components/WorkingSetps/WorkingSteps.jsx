      ...
      <div className=" relative z-50 max-w-[1440px] mx-auto  px-4 md:px-14 xl:px-[70px] pt-9 pb-16">
        ...
        <div className=" hidden lg:block w-[950px] xl:w-[1392px] h-[400px] xl:h-[472px] absolute top-10 xl:-top-14 left-0 -z-50">
          ...
          >
            ...
            <path
              ...
              strokeDasharray="8 8"
            />
            <circle cx="31" cy="347" r="12" fill="#EF4B23" />
            <circle cx="1380" cy="273" r="12" fill="#EF4B23" />
            <path
            ...
            <g opacity="0.4">
              <circle cx="515" cy="125" r="14.5" stroke="#EF4B23" />
              <circle cx="515" cy="125" r="9.5" stroke="#EF4B23" />
              <circle cx="515" cy="125" r="19.5" stroke="#EF4B23" />
            </g>
          </svg>
        </div>
        {/* small device svg */}
        <div className="absolute left-0 block md:hidden top-5 -z-50">
          ...
          >
            ...
            />
            <g opacity="0.4">
              <circle cx="102.518" cy="14.9482" r="9.96112" stroke="#EF4B23" />
              <circle cx="102.518" cy="14.948" r="6.47408" stroke="#EF4B23" />
              <circle cx="102.518" cy="14.9482" r="13.4482" stroke="#EF4B23" />
            </g>
            <path
              opacity="0.3"
              ...
              strokeDasharray="8 8"
            />
            <circle cx="8.57031" cy="165" r="5" fill="#EF4B23" />
            <circle cx="380.57" cy="144" r="5" fill="#EF4B23" />
            <path
              opacity="0.3"
