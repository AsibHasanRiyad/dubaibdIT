      ...
      <div className=" relative pt-[50px] lg:pt-[120px]">
        ...
        <div className=" hidden lg:block w-[550px] xl:w-[809px] absolute top-0 left-1/4">
          ...
          >
            ...
            />
            <g opacity="0.4">
              <circle cx="600.767" cy="132.977" r="13.4898" stroke="#EF4B23" />
              <circle cx="600.767" cy="132.976" r="8.82655" stroke="#EF4B23" />
              <circle cx="600.767" cy="132.977" r="18.1531" stroke="#EF4B23" />
            </g>
            <circle
              opacity="0.8"
              cx="11.9131"
        ...
        {/* mobile svg */}
        <div className="absolute block md:hidden top-14 right-8">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="174"
            height="54"
          ...
          >
            <path
              opacity="0.3"
              d="M5.84348 8.63845C12.3249 13.5942 28.9695 23.9592 43.6965 25.7729C62.1052 28.0399 81.8655 17.9041 94.1073 23.281C106.349 28.6579 106.386 45.4966 122.178 46.3332C137.969 47.1698 144.008 31.4697 158.043 31.1133"
              stroke="#EF4B23"
              strokeWidth="1.5"
              strokeDasharray="8 8"
            />
            <path
              d="M158.08 33.3763L158.049 26.969C158.042 25.5501 159.474 24.5755 160.791 25.1023L168.404 28.146C170.047 28.8031 170.09 31.1136 168.473 31.8313L160.891 35.1948C159.572 35.7798 158.087 34.8189 158.08 33.3763Z"
              fill="#EF4B23"
            />
            <g opacity="0.4">
              <circle cx="127.488" cy="13.9179" r="4.68841" stroke="#EF4B23" />
              <circle cx="127.488" cy="13.9179" r="2.95894" stroke="#EF4B23" />
              <circle cx="127.488" cy="13.9179" r="6.41788" stroke="#EF4B23" />
            </g>
            <circle
              opacity="0.8"
              cx="4.07031"
